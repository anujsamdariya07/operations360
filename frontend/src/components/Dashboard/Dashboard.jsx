    ...
    <div className="min-h-screen p-6 bg-[#222222] text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <div className="text-2xl font-semibold text-[#ff851b]">{stat.value}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-[#2d2d2d] p-6 rounded-2xl border-l-4 border-[#ff851b]">
          <h2 className="text-lg font-semibold text-[#ff851b] mb-1">Today's Revenue</h2>
          <p className="text-2xl font-bold">{systemStats.revenueToday}</p>
        </div>
        <div className="bg-[#2d2d2d] p-6 rounded-2xl border-l-4 border-[#ff851b]">
          <h2 className="text-lg font-semibold text-[#ff851b] mb-1">Active Users</h2>
          <p className="text-2xl font-bold">{systemStats.activeUsers}</p>
        </div>
        <div className="bg-[#2d2d2d] p-6 rounded-2xl border-l-4 border-[#ff851b]">
          <h2 className="text-lg font-semibold text-[#ff851b] mb-1">Low Stock Items</h2>
      ...
      <div className="bg-[#2d2d2d] p-6 rounded-2xl border border-[#ff851b]/20 mb-10">
        <h2 className="text-xl font-semibold text-[#ff851b] mb-4">Recent Orders</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#2d2d2d] p-6 rounded-2xl border border-[#ff851b]/20 flex flex-col justify-center items-center">
          <h2 className="text-xl font-semibold text-[#ff851b] mb-2">
            Employees Present Today
          </h2>
          <p className="text-5xl font-bold text-green-400">10</p>
          <p className="text-gray-400 mt-2">Out of 12 total employees</p>
        </div>
      </div>
    </div>
  );
